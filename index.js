...
function setIndicator(color){
    ...
    indicator.style.boxShadow= `0 0 5px 5px ${color}`;
}
...
function handleCheckBoxChange(){
    ...
    allCheckBox.forEach((checkbox)=>{
        if(checkbox.checked) checkBoxCnt++;
    });

    if(passwordLength<checkBoxCnt){
        passwordLength=checkBoxCnt;
        handleSlider();
    }
}
